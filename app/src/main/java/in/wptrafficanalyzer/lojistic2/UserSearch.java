...
/**
 * Created by Asus Computer on 24.4.2015.
 */
...
public class UserSearch extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnTracker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent my3Intent = new Intent(UserSearch.this,UserTrackWorker.class);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent my3Intent = new Intent(UserSearch.this,LoginParse.class);
                startActivity(my3Intent);
            }
        });
    ...
    class LoadIdioms extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(UserSearch.this);
            ...
            runOnUiThread(new Runnable() {
                ...
                newone.setText(cargoship);
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            UserSearch.this, productsList,
                            R.layout.list_view, new String[] {TAG_PID,TAG_CARGONUMBER, TAG_NAME, TAG_PHONENUMBER, TAG_ADDRESS,TAG_DESTADDRESS,TAG_TYPE},
                            new int[] { R.id.pid,R.id.cargonumber,R.id.name, R.id.phonenumber, R.id.address,R.id.destadress,R.id.type});
